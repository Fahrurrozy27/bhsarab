    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?=base_url('welcome/tentang')?>">Tentang Papan Tulis</a></li>
                        <li><a href="<?=base_url('welcome/materi')?>">Materi Papan Tulis</a></li>
                        <li><a href="<?=base_url('welcome/kontak')?>">Kontak Papan Tulis</a></li>
                        <li><a href="http://papantulis.net">papantulis.net</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    <h6 class="footer_title"> <a href="<?=base_url('welcome')?>" data-toggle="modal" data-target="#exampleModalCenter">Masuk - Sign in</a></h6>
                    <ul class="list">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="javaScript:void(0);">BAHASA ARAB</a></li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang PapanTulis</h4>
                <p>
        ...
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                Papan Tulis <br> Copyright &copy;<script>
                document.write(new Date().getFullYear());
                </script> All rights reserved <span class="text-danger"></span> by
                <a href="http://papantulis.net" target="_blank">Papan Tulis</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
