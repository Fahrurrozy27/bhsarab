        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400"
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    ...
                    <p>Hello Students! , Materi bahasa arab dipapantulis dibagi menjadi 3 bagian, silahkan pilih bagian yang akan anda pelajari atau klik lanjutkan untuk melanjutkan belajar
                       </p>
                    <hr>
